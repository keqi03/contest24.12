...
condition_map
    : condition_map logicalOp condition_map
    | condition_key condition_value_list
    ;
...
condition_key
    ...
    | 'acs:PrincipalARN'
    | 'ecs:tag/<' FLOAT '>'
    | 'rds:ResourceTag/<' FLOAT '>'
    | 'oss:Delimiter'
    | 'oss:Prefix'
    ;

condition_value_list
    : condition_value_list logicalOp condition_value_list
    | ID
    ;

objects
    : service ',' action ',' resource_type ',' resource ',' alias
    ;
